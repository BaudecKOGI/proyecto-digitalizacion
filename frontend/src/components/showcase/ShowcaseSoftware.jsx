      ...
      <div className="mx-auto max-w-[1400px]">
        <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-[1.5fr_1fr] lg:gap-24">
          ...
          <div className="reveal relative w-full overflow-hidden rounded-sm bg-panel order-2 lg:order-1">
            ...
            <div className="aspect-[16/10] w-full bg-[url('https://fablab.ucontinental.edu.pe/wp-content/uploads/2023/05/fablab-continental-proyectos.jpg')] bg-cover bg-center transition-transform duration-1000 hover:scale-105 opacity-80"></div>
