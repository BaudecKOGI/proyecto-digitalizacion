  ...
  return (
    <header style={{
      ...
      <div style={{ color: 'var(--text-muted)', fontSize: '14px', fontWeight: '500' }}>
        Bienvenido, <strong style={{ color: 'var(--text-main)' }}>Editor</strong>
      </div>
        ...
        <div style={{ position: 'relative' }}>
          ...
          {isProfileOpen && (
            <div style={{ position: 'absolute', top: '110%', right: '0', background: 'var(--panel)', border: '1px solid var(--line)', borderRadius: '8px', width: '160px', zIndex: 10 }}>
              <div style={{ padding: '12px 16px', display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer', color: '#ef4444', fontSize: '13px', fontWeight: '500' }}>
