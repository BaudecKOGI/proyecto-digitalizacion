...
export default function Footer() {
  const footerLinks = [
    ...
    },
    {
      ...
      links: [
        { label: "Panel del Encargado", href: "/editor", external: false },
        { label: "Dashboard Administrativo", href: "/dashboard", external: false }
      ]
    }
  ];
    ...
    <footer className="relative bg-text pt-12 pb-6 px-[8vw] mt-16 md:mt-24">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-6 text-muted">
          <a href="#" className="hover:text-bg transition-colors" aria-label="Facebook">
          ...
          <a href="#" className="hover:text-bg transition-colors" aria-label="Twitter">
          ...
          <a href="#" className="hover:text-bg transition-colors" aria-label="LinkedIn">
          ...
          <a href="#" className="hover:text-bg transition-colors" aria-label="Instagram">
          ...
          <a href="#" className="hover:text-bg transition-colors" aria-label="YouTube">
